    ...
    <div class="flex flex-col border rounded-2xl shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="grid <md:grid-cols-1 grid-cols-2 grid-flow-row gap-x-4 gap-y-4 mb-5">
        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Version <label class="text-red-500 space-x-0 pl-0">*</label></label>
          <FieldX  
            class="col-span-12 !mt-0"
            :bind="{ readonly: !actionText }"
            :value="values.version" :errorText="formErrors.version?'failed':''"
            @input="v=>values.version=v"
            :hints="formErrors.version"
            label=""
            placeholder="Masukan Version APP"
            :check="false" />
        </div>
        ...
        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Link <label class="text-red-500 space-x-0 pl-0">*</label></label>
          <FieldX  
            class="col-span-12 !mt-0"
            :bind="{ readonly: !actionText }"
            :value="values.link" :errorText="formErrors.link?'failed':''"
            @input="v=>values.link=v"
            :hints="formErrors.link"
            label=""
            placeholder="Masukan Link APP"
            :check="false" />
        </div>

        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Type <label class="text-red-500 space-x-0 pl-0">*</label></label>
          <FieldX  
            class="col-span-12 !mt-0"
            :bind="{ readonly: !actionText }"
