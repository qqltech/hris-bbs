...
<div class="flex flex-col gap-y-3 w-[400px]">
  <div class="flex gap-x-4 px-2">
    <div class="flex flex-col border rounded-2xl shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="flex items-center mb-2 pb-4">
        <button @click="onBack" title="Kembali" class="mr-2"><Icon fa="arrow-left"/></button>
      ...
      <div class="grid grid-cols-1 gap-2 mb-5">
        <div>
            <label>Direktorat <label class="text-red-500 space-x-0 pl-0">*</label>
            <FieldSelect 
        ...
        <div class="items-start gap-y-2">
          <label>Status <label class="text-red-500 space-x-0 pl-0">*</label></label>
           <input
      ...
      <div class="flex justify-end mb-4 gap-4">
        <button v-show="actionText" @click="onSave" class="bg-green-500 hover:bg-green-600 text-white px-[15px] py-[6px] rounded-md w-32">
          <Icon fa="save"/> Simpan
        </button>
      </div>
      <!-- FORM END -->
