  ...
  <div class="flex gap-x-4 px-2">
    <div class="flex flex-col border rounded shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="grid <md:grid-cols-1 grid-cols-2 gap-2">
        <!-- START COLUMN -->
        <div>
          <label class="font-semibold">Proyek Kode<span class="text-red-500 space-x-0 pl-0">*</span></label>
          <FieldX :bind="{ readonly: !actionText }" class="w-full py-2 !mt-0" :value="values.proyek_kode"
            :errorText="formErrors.proyek_kode?'failed':''" @input="v=>values.proyek_kode=v" :hints="formErrors.proyek_kode"
            placeholder="Masukan Nama Proyek" :check="false" label="" />
        </div>
        <div>
          <label class="font-semibold">Proyek Nama<span class="text-red-500 space-x-0 pl-0">*</span></label>
          <FieldX :bind="{ readonly: !actionText }" class="w-full py-2 !mt-0" :value="values.proyek_nama"
            :errorText="formErrors.proyek_nama?'failed':''" @input="v=>values.proyek_nama=v" :hints="formErrors.proyek_nama"
            placeholder="Masukan Nama Proyek" :check="false" label="" />
        </div>
