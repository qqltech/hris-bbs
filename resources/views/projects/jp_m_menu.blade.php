    ...
    <div class="bg-gray-500 text-white rounded-t-md py-2 px-4">
      <div class="flex items-center">
        ...
        <div>
          ...
          <p class="text-gray-100">Master Menu</p>
        </div>
      </div>
    </div>
    <div class="p-4 grid <md:grid-cols-1 grid-cols-3 gap-2 ">
      ...
      <div>   
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
            ...
            :check="false"
            label="Sub Modul"
            placeholder="Tuliskan Nama Sub Modul"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
            ...
            :check="false"
            label="Menu"
            placeholder="Tuliskan Nama Menu"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
            ...
            :check="false"
            label="Path"
            placeholder="Tuliskan Nama Path, Ex: /m_menu"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
            ...
            :check="false"
            label="Endpoint"
            placeholder="Tuliskan Nama Endpoint, Ex: /m_menu"
        />
      </div>
      <div>
        <FieldX :bind="{ readonly: !actionText }" class="w-full !mt-3"
            ...
            :check="false"
            label="Icon"
            placeholder="Tuliskan Nama Icon, Ex: bookmark"
        />
      </div>
      <div>
        <FieldNumber :bind="{ readonly: !actionText }" class="w-full !mt-3"
            ...
            :check="false"
            label="Sequence"
            placeholder="Tuliskan Sequence, Ex: 2.4"
        />
      </div>
      <div>
        <FieldX  
