    ...
    <div class="flex flex-col border rounded-2xl shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="grid <md:grid-cols-1 grid-cols-2 grid-flow-row gap-x-4 gap-y-4 mb-5">
        <!-- <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Direktorat</label>
          <FieldX  
        ...
        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">group <label class="text-red-500 space-x-0 pl-0">*</label></label>
          <FieldX  
            class="col-span-12 !mt-0"
        ...
        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Value 2<label class="text-red-500 space-x-0 pl-0">*</label></label>
          <FieldX  
            class="col-span-12 !mt-0"
            :bind="{ readonly: !actionText }"
            :value="values.value_2" :errorText="formErrors.value_2?'failed':''"
            @input="v=>values.value_2=v"
            :hints="formErrors.value_2"
            label=""
            placeholder="Tuliskan Value"
            :check="false" />
        </div>
