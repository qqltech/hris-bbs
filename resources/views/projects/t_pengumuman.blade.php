    ...
    <div class="flex flex-col border rounded-2xl shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="grid <md:grid-cols-1 grid-cols-2 grid-flow-row gap-x-4 gap-y-4 mb-5">
        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Judul <label class="text-red-500 space-x-0 pl-0">*</label></label>
          <FieldX  
        ...
        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Gambar Thumbnail <label class="text-red-500 space-x-0 pl-0">*</label></label>
          <FieldUpload
            class="col-span-12 !mt-0"
            :bind="{ readonly: !actionText }"
            ...
            :api="{
             ...
             :hints="formErrors.thumb" placeholder="Masukan Gambar Thumbnail" fa-icon="upload"
        ...
        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Tag <label class="text-red-500 space-x-0 pl-0"></label></label>
          <FieldX  
            class="col-span-12 !mt-0"
            :bind="{ readonly: !actionText }"
        ...
        <div class="grid grid-cols-12 items-center gap-y-2">
          <label class="col-span-12">Content <label class="text-red-500 space-x-0 pl-0">*</label></label>
          <FieldX  
            class="col-span-12 !mt-0"
            type="textarea"
            :bind="{ readonly: !actionText }"
