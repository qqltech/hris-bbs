  ...
  <div class="flex gap-x-4 px-2">
    <div class="flex flex-col border rounded shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="grid <md:grid-cols-1 grid-cols-2 gap-2">
        ...
        <div>
          <label class="font-semibold">No. KTP<span class="text-red-500 space-x-0 pl-0">*</span></label>
          <FieldX :bind="{ readonly: !actionText }" label="" placeholder="Tuliskan No. KTP" class="w-full py-2 !mt-0"
        ...
        <div>
          ...
          <FieldX :bind="{ readonly: !actionText }" label="" placeholder="Tuliskan Nama" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Alamat<span class="text-red-500 space-x-0 pl-0">*</span></label>
          <FieldX :bind="{ readonly: !actionText }" label="" placeholder="Tuliskan Alamat" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Telepon<span class="text-red-500 space-x-0 pl-0"></span></label>
          <FieldX :bind="{ readonly: !actionText }" label="" placeholder="Tuliskan No. Telepon" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Tempat Lahir<span class="text-red-500 space-x-0 pl-0"></span></label>
          <FieldX :bind="{ readonly: !actionText }" label="" placeholder="Tuliskan Tempat Lahir" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Tanggal Lahir<span class="text-red-500 space-x-0 pl-0"></span></label>
          <FieldX :bind="{ readonly: !actionText , required: true}" type="date" label="" placeholder="Pilih Tanggal Lahir" class="w-full py-2 !mt-0"
