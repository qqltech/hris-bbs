  ...
  <div class="flex gap-x-4 px-2">
    <div class="flex flex-col border rounded shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="grid <md:grid-cols-1 grid-cols-2 gap-2">
        <!-- START COLUMN -->
        <div>
          <label for="Master" class="font-semibold select-all">Modul <label class="text-red-500 space-x-0 pl-0"></label></label>
        ...
        <div>
          <label class="font-semibold">Submodul <label class="text-red-500 space-x-0 pl-0"></label></label>
          <FieldX :bind="{ readonly: !actionText }" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Menu <label class="text-red-500 space-x-0 pl-0"></label></label>
          <FieldX :bind="{ readonly: !actionText }" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Path <label class="text-red-500 space-x-0 pl-0"></label></label>
          <FieldX :bind="{ readonly: !actionText }" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Endpoint <label class="text-red-500 space-x-0 pl-0"></label></label>
          <FieldX :bind="{ readonly: !actionText }" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Icon <label class="text-red-500 space-x-0 pl-0"></label></label>
          <FieldX :bind="{ readonly: !actionText }" class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">Sequence <label class="text-red-500 space-x-0 pl-0"></label></label>
        ...
        <div>
          ...
          <FieldX :bind="{ readonly: !actionText }" class="w-full py-2 !mt-0"
              ...
              type="textarea"
              label=""
              placeholder="Halaman ini digunakan untuk konfigurisi menu-menu yang akan tampil pada sidebar"
          />
        </div>
