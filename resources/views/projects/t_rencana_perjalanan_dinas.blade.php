  ...
  <div class="flex gap-x-4 px-2">
    <div class="flex flex-col border rounded shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="grid grid-cols-8 md:grid-cols-12 text-[14px] gap-x-[29px] gap-y-[26px]">
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            <label class="col-span-12">Template SPD<label class="text-red-500 space-x-0 pl-0">*</label></label>
            <FieldPopup
              :bind="{ readonly: !actionText }" class="col-span-12 !mt-0 w-full"
              :value="values.m_spd_id" 
              @input="(v)=>values.m_spd_id=v"
              :errorText="formErrors.m_spd_id?'failed':''" 
              :hints="formErrors.m_spd_id" 
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            <label class="col-span-12">Tanggal Pengajuan<label class="text-red-500 space-x-0 pl-0">*</label></label>
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            ...
            <FieldX :bind="{ readonly: !actionText, disabled: !actionText }" type="date" @update="hitungHari()" class="col-span-12 !mt-0 w-full"
              :value="values.tgl_acara_awal" :errorText="formErrors.tgl_acara_awal?'failed':''"
              @input="v=>{
                values.tgl_acara_awal=v
                hitungHari()
              }" :hints="formErrors.tgl_acara_awal" :check="false"
              label="" placeholder=""
            />
          </div>
        </div>
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            ...
            <FieldX :bind="{ readonly: !actionText, disabled: !actionText }" type="date" class="col-span-12 !mt-0 w-full"
              :value="values.tgl_acara_akhir" :errorText="formErrors.tgl_acara_akhir?'failed':''"
              @input="v=>{
                values.tgl_acara_akhir=v
                hitungHari()
                }" :hints="formErrors.tgl_acara_akhir" :check="false"
              label="" placeholder=""
            />
          </div>
        </div>
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            <label class="col-span-12">Jenis SPD <label class="text-red-500 space-x-0 pl-0">*</label></label>
            <FieldSelect
              :bind="{ disabled: !actionText, clearable:false }" class="col-span-12 !mt-0 w-full"
              :value="values.jenis_spd_id" @input="v=>values.jenis_spd_id=v"
              label="" placeholder="Pilih Posisi"
              :errorText="formErrors.jenis_spd_id?'failed':''" 
              :hints="formErrors.jenis_spd_id"
              :api="{
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            ...
            <FieldSelect
              :bind="{ disabled: !actionText, clearable:false }" class="col-span-12 !mt-0 w-full"
              :value="values.m_zona_asal_id" @input="v=>values.m_zona_asal_id=v"
              label="" placeholder="Pilih Posisi"
              :errorText="formErrors.m_zona_asal_id?'failed':''" 
              :hints="formErrors.m_zona_asal_id"
              :api="{
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            ...
            <FieldSelect
              :bind="{ disabled: !actionText, clearable:false }" class="col-span-12 !mt-0 w-full"
              :value="values.m_zona_tujuan_id" @input="v=>values.m_zona_tujuan_id=v"
              label="" placeholder="Pilih Posisi"
              :errorText="formErrors.m_zona_tujuan_id?'failed':''" 
              :hints="formErrors.m_zona_tujuan_id"
              :api="{
                  url: `${store.server.url_backend}/operation/m_zona`,
                  headers: { 'Content-Type': 'Application/json', Authorization: `${store.user.token_type} ${store.user.token}`},
                  params: {
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            ...
            <FieldSelect
              :bind="{ disabled: !actionText, clearable:false }" class="col-span-12 !mt-0 w-full"
              :value="values.m_lokasi_tujuan_id" @input="v=>values.m_lokasi_tujuan_id=v"
              label="" placeholder="Pilih Posisi"
              :errorText="formErrors.m_lokasi_tujuan_id?'failed':''" 
              :hints="formErrors.m_lokasi_tujuan_id"
              :api="{
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            ...
            <FieldPopup
              :bind="{ readonly: !actionText }" class="col-span-12 !mt-0 w-full"
              :value="values.pic_id" @input="(v)=>values.pic_id=v"
              ...
              placeholder="Cari Nama Karyawan" label="" :check="false" 
              :columns="[{
                headerName: 'No',
                valueGetter:(p)=>p.node.rowIndex + 1,
                width: 60,
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            ...
            <FieldNumber
              ...
              :value="values.total_biaya" @input="(v)=>values.total_biaya=v"
              :errorText="formErrors.total_biaya?'failed':''" 
              :hints="formErrors.total_biaya"
        ...
        <div class="col-span-8 md:col-span-6">
          <div class="grid grid-cols-12 items-center gap-y-2">
            <label class="col-span-12">Kegiatan<label class="text-red-500 space-x-0 pl-0">*</label></label>
            <FieldX :bind="{ readonly: !actionText }" type="textarea" class="col-span-12 !mt-0 w-full"
              :value="values.kegiatan" :errorText="formErrors.kegiatan?'failed':''"
              @input="v=>values.kegiatan=v" :hints="formErrors.kegiatan" :check="false"
              label="" placeholder="Tuliskan Kegiatan"
            />
          </div>
        </div>
        <div class="col-span-8 md:col-span-6">
        ...
        <div class="col-span-8 md:col-span-6" v-show="values.is_kend_dinas">
          <div class="grid grid-cols-12 items-center gap-y-2">
            <label class="col-span-12">Catatan Kendaraan<label class="text-red-500 space-x-0 pl-0">*</label></label>
            <FieldX :bind="{ readonly: !actionText }" type="textarea" class="col-span-12 !mt-0 w-full"
              :value="values.catatan_kend" :errorText="formErrors.catatan_kend?'failed':''"
              @input="v=>values.catatan_kend=v" :hints="formErrors.catatan_kend" :check="false"
              label="" placeholder="Tuliskan Catatan Kendaraan"
            />
          </div>
        </div>
        <!-- <div class="flex flex-col gap-2">
          ...
          <div class="flex w-40 items-center">
            ...
            <div class="flex-auto">
              <i class="text-green-500">In Approval</i>
            </div>
          </div>
        </div> -->
          ...
          <table class="w-full overflow-x-auto table-auto border border-[#CACACA]">
            <thead>
              <tr class="border">
                ...
                <td class="text-[#8F8F8F] font-semibold text-[14px] text-capitalize px-2 text-center w-[20%] border bg-[#f8f8f8] border-[#CACACA]">Tipe</td>
                ...
                <td class="text-[#8F8F8F] font-semibold text-[14px] text-capitalize px-2 text-center border w-[20%] bg-[#f8f8f8] border-[#CACACA]">Keterangan</td>
            ...
            <tbody>
              <tr v-for="(item, i) in detailArr" :key="item.id" class="border-t" v-if="detailArr.length > 0">
                ...
                <td class="p-2 border border-[#CACACA]">
                  <FieldX :bind="{ readonly: !actionText }" class="!mt-0" type="textarea"
