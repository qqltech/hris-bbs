  ...
  <div class="flex flex-col border rounded-md shadow-md md:w-full w-full p-0 bg-white border-none">
    <div class="bg-gray-500 text-white rounded-t-md py-2 px-4">
      <div class="flex items-center">
        ...
        <div>
          <h1 class="text-20px font-bold">Form Tunjangan Kemahalan</h1>
          <p class="text-gray-100">Master Tunjangan Kemahalan</p>
        </div>
      </div>
    </div>
    <div class="p-4 grid <md:grid-cols-1 grid-cols-3 gap-2 ">
      ...
      <div>
        <FieldX :bind="{ readonly: true }"  class="w-full !mt-3"
          ...
          label="Kode" placeholder="Auto Generate Kode"
        />
      </div>
      <div>   
        <FieldSelect
          ...
          label="Zona" placeholder="Pilih Zona"
      ...
      <div>
        <FieldSelect
          ...
          label="Grading" placeholder="Pilih Grading"
      ...
      <div>
        <FieldNumber
          ...
          label="Besaran" placeholder="Tuliskan Besaran" :check="false"
        />
      </div>
      <div>
        <FieldSelect
          ...
          label="Posisi" placeholder="Pilih Posisi"
