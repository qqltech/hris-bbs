...
class mspddettransport extends Migration
{
    protected $tableName = "m_spd_det_transport";
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->bigInteger('m_spd_det_biaya_id')->comment('{"fk":"m_spd_det_biaya.id"}')->nullable();
            $table->bigInteger('jenis_transport_id')->comment('{"src":"m_general.id"}')->nullable();
            $table->string('nama_transport');
            $table->decimal('biaya_transport', 12 ,2 );
