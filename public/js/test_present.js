...
// ------------------------------ PERSIAPAN
const endpointApi = '/m_lembur'
onBeforeMount(()=>{
  document.title = 'Master Lembur'
})
...
const landing = reactive({
  ...
  },
  {
    ...
    resizable: true,
    flex:1,
    cellClass: [ 'border-r', '!border-gray-200', 'justify-left', 'capitalize'],
  },
  {
    field: 'm_dept.nama',
  ...
  },
  {
    ...
    resizable: true,
    flex:1,
    cellClass: [ 'border-r', '!border-gray-200', 'justify-end', 'capitalize']
  }]
})
onActivated(() => {
