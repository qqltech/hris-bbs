...
// ------------------------------ PERSIAPAN
const endpointApi = '/m_tunj_kemahalan'
onBeforeMount(()=>{
  document.title = 'Master Tunjangan Kemahalan'
})
...
const landing = reactive({
  ...
  api: {
    ...
    params: {
      simplest: true,
      join: true,
      searchfield:'this.id, m_dir.nama, this.kode, m_divisi.nama, m_dept.nama, m_zona.nama, m_posisi.desc_kerja, this.besaran',
    },
    onsuccess(response) {
  ...
  },
  {
    headerName: 'Besaran',
    cellRenderer: ( params ) => {
      return formatCurrency(params.data.besaran)
    },
    filter: true,
    sortable: true,
    filter: 'ColFilter',
