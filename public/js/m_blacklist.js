...
// ------------------------------ PERSIAPAN
const endpointApi = '/m_blacklist'
onBeforeMount(()=>{
  document.title = 'Master Blacklist'
})
...
const landing = reactive({
  ...
  api: {
    ...
    params: {
      simplest: true,
      searchfield:'this.id, this.no_ktp, this.nama, this.telp, this.alamat, this.tgl_lahir, this.tempat_lahir',
    },
    onsuccess(response) {
