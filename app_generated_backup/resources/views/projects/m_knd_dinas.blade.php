  ...
  <div class="flex gap-x-4 px-2">
    <div class="flex flex-col border rounded shadow-sm px-6 py-6 <md:w-full w-full bg-white">
      ...
      <div class="grid <md:grid-cols-1 grid-cols-2 gap-2">
        ...
        <div>
          <label class="font-semibold">Nama Kendaraan<span class="text-red-500 space-x-0 pl-0">*</span></label>
          <FieldX :bind="{ readonly: !actionText }" label=""  class="w-full py-2 !mt-0"
        ...
        <div>
          <label class="font-semibold">No.Polisi<span class="text-red-500 space-x-0 pl-0">*</span></label>
          <FieldX :bind="{ readonly: !actionText }" label="" class="w-full py-2 !mt-0"
              :value="values.nopol" :errorText="formErrors.nopol?'failed':''"
              @input="v=>values.nopol=v" :hints="formErrors.nopol" 
              :check="false"
              label=""
              placeholder=" AE XXXX BE"
          />
        </div>
        <div>
          <label class="font-semibold">lokasi<span class="text-red-500 space-x-0 pl-0">*</span></label>
          <FieldSelect
          class="w-full py-2 !mt-0"
            :value="values.m_lokasi_id"
            @input="v=>values.m_lokasi_id=v" 
            ...
            placeholder="Pilih Lokasi" label="" :check="false"
          />
        </div>
        <div>
