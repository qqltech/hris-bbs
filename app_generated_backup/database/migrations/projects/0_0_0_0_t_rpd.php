...
class trpd extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->bigInteger('t_spd_id')->comment('{"src":"t_spd.id"}');
            $table->decimal('total_biaya_spd',22,2);
            $table->decimal('total_biaya_selisih',22,2);
            $table->decimal('pengambilan_spd',22,2);
