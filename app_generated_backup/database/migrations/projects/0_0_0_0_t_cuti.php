...
class tcuti extends Migration
{
    protected $tableName = "t_cuti";
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->bigInteger('alasan_id')->comment('{"src":"m_general.id"}')->nullable();
            $table->bigInteger('tipe_cuti_id')->comment('{"src":"m_general.id"}')->nullable();
