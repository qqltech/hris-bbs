...
class mpengurangangaji extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->bigInteger('comp_id')->comment('{"src":"m_comp.id"}')->nullable();
            $table->string('tipe',100);
            $table->decimal('k_minimun', 12, 2)->nullable();
            $table->decimal('k_maksimum', 12, 2)->nullable();
            $table->string('berdasarkan', 100);
            $table->decimal('n_pengurangan', 12, 2);
