...
class t_riwayat_posisi extends \App\Models\BasicModels\t_riwayat_posisi
{    
    private $helper;
    ...
    public function createBefore( $model, $arrayData, $metaData, $id=null )
    {
        $newArrayData  = array_merge( $arrayData,[
            'nomor' => $this->helper->generateNomor('KODE RIWAYAT POSISI')
        ]);
    ...
    {
        $data = t_riwayat_posisi::find($request->id);
