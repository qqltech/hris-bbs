...
{   
    ...
    public $details     = [];
<<<<<<< HEAD
    public $heirs       = ["m_jam_kerja","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary_det_kartu","m_kary_det_kel","m_kary_det_kel","m_kary_det_kel","m_kary_det_kel","m_kary_det_org","m_kary_det_org","m_kary_det_pel","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pend","m_kary_det_pend","m_kary_det_pk","m_kary_det_pres","m_lembur","m_posisi","m_posisi","m_spd","m_spd_det_biaya","m_spd_det_transport","m_standart_gaji","m_tunj_kemahalan","t_cuti","t_cuti","t_final_gaji_det","t_loker","t_loker","t_mutasi","t_pelamar","t_pelamar_det_kartu","t_lembur","t_lembur","t_pelamar_det_org","t_pelamar_det_org","t_pelamar_det_pel","t_pelamar_det_pend","t_pelamar_det_pend","t_pelamar_det_peng","t_pelamar_det_pk","t_pelamar_det_pres","t_perhitungan_gaji","t_riwayat_posisi_det","t_riwayat_posisi_det","t_rpd_det","t_sgp","t_spd","t_spd_det","t_cuti_adjustment","t_potongan"];
=======
    public $heirs       = ["m_kary_det_pel","t_final_gaji_det","t_pelamar_det_pres","t_cuti","t_cuti","t_rpd_det","m_kary_det_kartu","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pemb","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","t_pelamar_det_pk","t_spd","t_jadwal_kerja","t_potongan","t_cuti_adjustment","t_pelamar_det_pel","m_kary_det_pk","t_pelamar","m_kary_det_kel","m_kary_det_kel","m_kary_det_kel","m_kary_det_kel","t_pelamar_det_peng","m_kary_det_org","m_kary_det_org","t_perhitungan_gaji","m_lembur","m_kary_det_pend","m_kary_det_pend","t_spd_det","t_pelamar_det_kartu","t_lembur","t_lembur","m_jam_kerja","t_sgp","t_loker","t_loker","t_riwayat_posisi_det","t_riwayat_posisi_det","m_spd_det_biaya","m_tunj_kemahalan","t_pelamar_det_pend","t_pelamar_det_pend","m_spd","m_spd_det_transport","m_posisi","m_posisi","m_standart_gaji","t_mutasi","m_kary_det_pres","t_pelamar_det_org","t_pelamar_det_org"];
>>>>>>> d2f2a633ace974b33fb01ec39f0a70cfbc680f93
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
