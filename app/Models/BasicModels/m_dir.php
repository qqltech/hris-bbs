...
{   
    ...
    public $details     = [];
    public $heirs       = ["m_kary_det_pel","t_final_gaji_det","t_cuti","m_kary_det_kartu","m_kary_det_pemb","m_file","m_general","m_kary","default_users","t_spd","m_pengguna","t_potongan","t_cuti_adjustment","t_grup_kerja","m_menu","m_kary_det_bhs","m_kary_det_pk","t_pelamar","m_kary_det_kel","t_hasil_tes","t_riwayat_posisi","m_kary_det_org","m_approval","t_perhitungan_gaji","m_dept","m_lembur","m_divisi","m_kary_det_pend","generate_approval","m_role","t_lembur","m_role_access","m_role_det","m_lokasi","m_zona","m_zona_det","m_jam_kerja","t_sgp","generate_approval_log","t_loker","m_spd_det_biaya","m_tunj_kemahalan","m_knd_dinas","m_libur_nasional","m_spd","t_jadwal_kerja","m_spd_det_transport","m_posisi","m_standart_gaji","t_mutasi","m_kary_det_pres"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
