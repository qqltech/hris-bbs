...
=======
    public $heirs       = ["t_final_gaji_det","m_kary","t_spd","t_jadwal_kerja","t_grup_kerja","t_pelamar","t_perhitungan_gaji","m_lembur","t_jadwal_kerja_det","t_loker","m_tunj_kemahalan","m_spd","m_standart_gaji","t_mutasi","t_mutasi"];
