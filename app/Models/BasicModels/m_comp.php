...
{   
    ...
    public $details     = [];
    public $heirs       = ["m_divisi","m_dir","m_general","m_jam_kerja","m_jarak_kota","m_kary","m_kary_det_bhs","m_kary_det_kartu","m_kary_det_kel","default_users","generate_approval_log","generate_approval","m_approval","m_contract","m_kary_det_org","m_kary_det_pel","m_kary_det_pemb","m_kary_det_pend","m_kary_det_pk","m_kary_det_pres","m_knd_dinas","m_libur_nasional","m_lokasi","m_menu","m_pengesahan_doc","m_pengurangan_gaji","m_periode","m_posisi","m_role","m_role_access","m_role_det","m_spd","m_spd_det_transport","m_standart_gaji","m_tunj_kemahalan","m_zona","t_cuti","t_final_gaji","presensi_absensi","t_grup_kerja","t_hasil_tes","t_jadwal_kerja","t_loker","t_mutasi","t_pelamar","t_lembur","t_potongan","t_riwayat_posisi","t_rpd","t_sgp","t_spd"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
