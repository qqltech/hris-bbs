...
{   
    ...
    public $details     = [];
<<<<<<< HEAD
    public $heirs       = ["m_divisi","m_dir","m_general","m_jam_kerja","m_jarak_kota","m_kary","m_kary_det_bhs","m_kary_det_kartu","m_kary_det_kel","default_users","generate_approval_log","generate_approval","m_approval","m_contract","m_kary_det_org","m_kary_det_pel","m_kary_det_pemb","m_kary_det_pend","m_kary_det_pk","m_kary_det_pres","m_knd_dinas","m_libur_nasional","m_lokasi","m_menu","m_pengesahan_doc","m_pengurangan_gaji","m_periode","m_posisi","m_role","m_role_access","m_role_det","m_spd","m_spd_det_transport","m_standart_gaji","m_tunj_kemahalan","m_zona","t_cuti","t_final_gaji","presensi_absensi","t_grup_kerja","t_hasil_tes","t_jadwal_kerja","t_loker","t_mutasi","t_pelamar","t_lembur","t_riwayat_posisi","t_rpd","t_sgp","t_spd","t_potongan_det_bayar","t_cuti_adjustment","t_potongan"];
=======
    public $heirs       = ["m_kary_det_pel","m_pengesahan_doc","t_cuti","m_periode","t_final_gaji","m_kary_det_kartu","t_potongan_det_bayar","m_kary_det_pemb","m_kary","m_general","default_users","t_spd","t_jadwal_kerja","m_dir","t_potongan","t_cuti_adjustment","t_grup_kerja","m_menu","m_kary_det_bhs","m_kary_det_pk","m_pengurangan_gaji","t_pelamar","m_kary_det_kel","t_hasil_tes","t_riwayat_posisi","m_kary_det_org","m_approval","m_divisi","m_contract","m_kary_det_pend","presensi_lokasi","t_rpd","generate_approval","presensi_absensi","m_role","t_lembur","m_role_access","m_role_det","m_lokasi","m_zona","m_jam_kerja","t_sgp","generate_approval_log","t_loker","m_tunj_kemahalan","m_knd_dinas","m_libur_nasional","m_spd","m_spd_det_transport","m_posisi","m_standart_gaji","t_mutasi","m_kary_det_pres","m_jarak_kota"];
